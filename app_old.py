...
WORKOUTS = {
    "Тренировка A": ["Тяга в наклоне", "Жим лежа", "Подтягивания обратным хватом",  "Жим на наклонной скамье", "Сгибание рук со штангой", "Разгибание трицепса"],
    "Тренировка B": ["Приседания со штангой", "Армейский жим", "Выпады со штангой", "Тяга штанги к подбородку","Икроножные", "Скручивания" ],
    "Тренировка C": ["Жим узким хватом", "Тяга верхнего блока", "Отжимания", "Тяга горизонтального блока", "Отжимания на боусьях", "Гантели на бицепс"],
    "Тренировка D": ["Жим ногами", "Разведение гантелей", "Выпрямление ног", "Тяга блока к лицу", "Икры сидя", "Книжка"]
}
